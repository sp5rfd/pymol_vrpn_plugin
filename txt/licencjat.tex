...
\\
\\
\includegraphics[scale=0.35,right]{MooresLaw}
\\
\\
...
diagram prezentujący stanowisko pracy (komputer+haptic+vrpn+pymol)

	W dalszej części pracy szczegółowo zostanie opisane stanowisko pracy.

\chapter{Metody lokalnego dopasowania struktur chemicznych}
...
\includegraphics[scale=0.5]{Sensable_Phantom_Omni}
